...
return [
    ...
    'notif_card_owner_rejected_title' => 'لم تتم الموافقة على بطاقتك',
    'notif_card_owner_rejected_body'  => 'لم توافق شركتك على بطاقتك: :reason. يمكنك تعديلها وإرسالها مرة أخرى.',
    'notif_card_ready_title' => 'بطاقتك التعريفية جاهزة',
    'notif_card_ready_body'  => 'أنشأت شركتك بطاقتك التعريفية الرقمية. افتح التطبيق لإضافة صورتك وألوانك ونبذتك.',
    'notif_contact_received_title' => 'شارك أحدهم بياناته معك',
    'notif_contact_received_body'  => 'شارك :name بيانات التواصل الخاصة به بعد الاطلاع على بطاقتك.',
    'contact_shared' => 'شكرًا لك — تم إرسال بياناتك.',
    'contact_not_found' => 'جهة الاتصال غير موجودة.',

    'card_already_editable' => 'هذه البطاقة متاحة للتعديل بالفعل.',
    'card_already_reviewed' => 'راجعت شركتك هذه البطاقة بالفعل، لذا لم يعد بالإمكان سحبها.',
    'business_card_reopened' => 'تم فتح البطاقة للتعديل. تبقى بطاقتك المنشورة متاحة حتى تتم الموافقة على النسخة الجديدة.',
